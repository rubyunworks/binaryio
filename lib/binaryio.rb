# BinaryIO is a simple subclass of IO that includes the BinaryIO::Readable
# mixin, which is the core of BinaryIO's functionality.
#
class BinaryIO < IO

  # Current version of BinaryIO project.
  VERSION = "1.0.1"
